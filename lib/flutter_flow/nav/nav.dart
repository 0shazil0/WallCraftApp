...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Fulscreenpage',
          path: '/fulscreenpage',
          builder: (context, params) => FulscreenpageWidget(
            imageReference: params.getParam('imageReference',
        ...
        FFRoute(
          name: 'ArtistProfile',
          path: '/artistProfile',
          builder: (context, params) => ArtistProfileWidget(
            artistprofile: params.getParam(
                'artistprofile', ParamType.DocumentReference, false, ['user']),
          ),
        ),
        FFRoute(
